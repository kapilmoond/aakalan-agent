...
export const en: Translations = {
  ...
  boot: {
    ready: 'Aakalan Agent Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Aakalan Agent settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting Aakalan Agent Desktop…'
    },
    errors: {
      backgroundExited: 'Aakalan Agent background process exited.',
      backgroundExitedDuringStartup: 'Aakalan Agent background process exited during startup.',
    ...
    failure: {
      title: "Aakalan Agent couldn't start",
      description:
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Aakalan Agent backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateHermes: 'Update Aakalan Agent',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Aakalan Agent Desktop.',
    ...
    native: {
      ...
      inputBody: 'Aakalan Agent is waiting for your response.',
      turnDoneTitle: 'Aakalan Agent finished',
      turnDoneBody: '',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Aakalan Agent defaults?',
    ...
    plugins: {
      ...
      agent: {
        title: 'Agent plugins',
        blurb:
          'Run in the Aakalan Agent backend — tools, skills, MCP servers, hooks, and slash commands. Portable ones are Agent Plugins packages (skills + MCP bundles that work in other agents too). Toggles apply to new sessions.',
        ...
        updateBackendToManage: 'Update the Aakalan Agent backend to manage this plugin from Desktop.',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Aakalan Agent is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Aakalan Agent asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Aakalan Agent was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while Aakalan Agent was in the background.'
        }
      },
      test: 'Send test notification',
      testTitle: 'Aakalan Agent',
    ...
    searchPlaceholder: {
      about: 'About Aakalan Agent Desktop',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Aakalan Agent follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Aakalan Agent can react to yours.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Aakalan Agent is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Aakalan Agent, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Aakalan Agent checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Aakalan Agent configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Aakalan Agent.',
    ...
    connections: {
      title: 'Connections',
      intro:
        'Register every place your agents live — this device, remote gateways on your network, and Aakalan Agent Cloud instances. All of them are stored here.',
      stagedNote:
      ...
      updateSkippedCloud: 'Managed by Aakalan Agent Cloud',
      kindLocal: 'Local',
      kindRemote: 'Remote gateway',
      kindCloud: 'Aakalan Agent Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'The Aakalan Agent runtime managed by this app.',
      kindRemoteDesc: 'A Aakalan Agent gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your Aakalan Agent Cloud account.',
      kindSshDesc: 'A Aakalan Agent install reached over SSH.',
      labelTitle: 'Name',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Aakalan Agent backend elsewhere. Per-profile overrides below.',
      ...
      localDesc: 'Start a private Aakalan Agent backend on localhost. This is the default and works offline.',
      inheritTitle: 'Use default gateway',
      inheritDesc: "Remove this profile's override and use the default connection.",
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Aakalan Agent backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Aakalan Agent Cloud',
      cloudDesc: 'Sign in once to Aakalan Agent Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Aakalan Agent Cloud',
      cloudSignIn: 'Sign in to Aakalan Agent Cloud',
      cloudSignedIn: 'Signed in to Aakalan Agent Cloud',
      cloudNeedsSignIn: 'Sign in to Aakalan Agent Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Aakalan Agent Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Aakalan Agent Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Aakalan Agent Cloud',
      cloudSignedOutMessage: 'Cleared the Aakalan Agent Cloud session.',
      ...
      restartingMessage: 'Aakalan Agent Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Aakalan Agent ${version}` : ''}`,
      ...
      sshDesc:
        'Aakalan Agent is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshHermesPathTitle: 'Aakalan Agent path (optional)',
      sshHermesPathDesc: 'Full path to the remote agent binary. Blank = auto-detect.',
      ...
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Aakalan Agent found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Aakalan Agent runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Aakalan Agent is not installed on the remote host. Install it there (see Aakalan Agent docs) or set the agent path.',
      sshErrPlatform:
        'Unsupported remote platform. Aakalan Agent Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Aakalan Agent on the remote host before connecting with Desktop SSH.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Aakalan Agent runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Aakalan Agent at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  starmap: {
    ...
    emptyDesc: 'As Aakalan Agent builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Aakalan Agent to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Aakalan Agent to generate pets.',
      backgroundHint: 'You can close this — Aakalan Agent will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Aakalan Agent desktop' },
    ...
    hermesActiveSessions: (version, count) => `Aakalan Agent ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Aakalan Agent environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'Aakalan Agent did not save that model change.'
    },
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Aakalan Agent will run it and deliver results to the destination you pick.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Aakalan Agent...',
    placeholderReconnecting: 'Reconnecting to Aakalan Agent…',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'What are we building?',
      'Give Aakalan Agent a task',
      "What's on your mind?",
    ...
    attachUrlDesc: 'Aakalan Agent will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Aakalan Agent to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Aakalan Agent…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Aakalan Agent…',
    ...
    unsupportedMessage: 'This version of Aakalan Agent can’t update itself from inside the app.',
    ...
    availableBody: 'A new version of Aakalan Agent is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected Aakalan Agent backend is ready to install.',
    ...
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Aakalan Agent desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Aakalan Agent updater takes over in its own window and reopens Aakalan Agent automatically when it’s done. Please don’t reopen Aakalan Agent yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Aakalan Agent reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Aakalan Agent reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Aakalan Agent needs a one-time install',
    ...
    setupChoiceTitle: 'Set up Aakalan Agent Desktop',
    setupChoiceDesc:
      'Connect this app to a Aakalan Agent gateway you already run, or install Aakalan Agent locally on this computer.',
    connectExistingTitle: 'Connect to existing Aakalan Agent',
    ...
    installLocalTitle: 'Install Aakalan Agent locally',
    ...
    probeError: 'Could not reach that Aakalan Agent gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    activeDesc:
      'This is a one-time setup. The Aakalan Agent installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Aakalan Agent',
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Aakalan Agent connects automatically',
    ...
    authorizeThere: 'Authorize Aakalan Agent there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Aakalan Agent there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Aakalan Agent Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `Aakalan Agent Cloud · ${host}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Aakalan Agent will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Aakalan Agent is restarting...',
      askRestart: 'Ask Aakalan Agent to restart the server',
      lookingRestart: taskId => `Aakalan Agent is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Aakalan Agent is working in the background. Watch the preview console for progress.',
      ...
      restartFailedMessage: 'Aakalan Agent could not restart the server.',
      stillWorking:
        'Aakalan Agent is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Aakalan Agent is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Aakalan Agent gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). Aakalan Agent won’t ask again for commands like this — in this session or any future one.`,
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Aakalan Agent Desktop to use Save Image.',
    restartToSaveImages: 'Restart Aakalan Agent Desktop to save images',
