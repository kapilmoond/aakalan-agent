#!/bin/bash
# ============================================================================
# Aakalan Agent CLI Installer
# ============================================================================
# Installation script for Linux, macOS, and Android/Termux.
# Uses uv for desktop/server installs and Python's stdlib venv + pip on Termux.
#
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/kapilmoond/aakalan-cli1/main/scripts/install.sh | bash
#
# Or with options:
...
# Configuration
REPO_URL_SSH="git@github.com:kapilmoond/aakalan-cli1.git"
REPO_URL_HTTPS="https://github.com/kapilmoond/aakalan-cli1.git"
HERMES_HOME="${AAKALAN_HOME:-${HERMES_HOME:-$HOME/.aakalan}}"
